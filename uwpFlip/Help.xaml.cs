...
namespace uwpFlip
{
    ...
    public sealed partial class Help : Page
    {
        public Help()
        {
            ...
            string lol3 = "Once the name is entered the user has to click the Add button present at the bottom of the page,it might take sometime for add button to get visible depending upon the Internet speed please wait for the same.A message will be popped when the product is addede.If an error message is shown then please check the Internet connectivity and if the problem is not resolved , then please send us the product link via  email on axejulius @outlook.com.";
